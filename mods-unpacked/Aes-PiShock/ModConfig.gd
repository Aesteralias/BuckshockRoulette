...
func _init():
	...
	if (err != OK): #If it cannot load config, set Default Values
		...
		config_values.set_value("Handcuffed","Intensity", 20)
		config_values.set_value("Handcuffed","Duration", 1.0)
		...
		config_values.set_value("Jammed","Intensity", 20)
		config_values.set_value("Jammed","Duration", 1)
